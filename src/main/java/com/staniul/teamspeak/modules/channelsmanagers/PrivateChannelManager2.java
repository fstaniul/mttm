...
public class PrivateChannelManager2 {
    private static Logger log = LogManager.getLogger(PrivateChannelManager2.class);
    ...
    @Autowired
    public PrivateChannelManager2(Query query, PrivateChannelClientMessenger messenger) {
        this.query = query;
