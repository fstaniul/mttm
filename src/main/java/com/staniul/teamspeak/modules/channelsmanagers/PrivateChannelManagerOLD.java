...
public class PrivateChannelManagerOLD {
    private static Logger log = LogManager.getLogger(PrivateChannelManagerOLD.class);
    ...
    @Autowired
    public PrivateChannelManagerOLD(Query query, PrivateChannelClientMessenger messenger) {
        this.query = query;
